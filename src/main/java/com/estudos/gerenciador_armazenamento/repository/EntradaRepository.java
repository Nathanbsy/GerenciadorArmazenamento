...
@Repository
public interface EntradaRepository extends JpaRepository<Movimentacao, Integer> {
    @Query("SELECT m FROM Movimentacao m WHERE m.produto.sku = :sku AND m.tipo = 'ENTRADA'")
